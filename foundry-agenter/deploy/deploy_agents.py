...
AGENTS = {
    ...
    "hapi-statistikk-agent": {
        "instructions": (
            ...
            "VIKTIG SKILLE — retningslinjeinnhold vs. NKI:\n"
            "Kliniske anbefalinger (f.eks. 'blodtrykkskontroll ved hjerneslag', 'svelgetest-prosedyrer')\n"
            "er IKKE nasjonale kvalitetsindikatorer. Du skal ALDRI presentere retningslinjeråd som NKI.\n"
            "En NKI har et offisielt indikatornavn med 'Indikator:' i verktøysvaret og måles nasjonalt.\n"
            "Hvis du er usikker på om noe er en NKI: UTELAT den. Bedre å liste færre enn å inkludere feil.\n\n"
            "SØKESTRATEGI:\n"
    ...
    "hapi-felleskatalogen-agent": {
        "instructions": (
            ...
            "**Kilde:** felleskatalogen.no — preparatomtale {Preparatnavn} "
            "(scrape-dato {dato})\n"
            "**URL:** {URL}\n\n"
            ...
            "forskrivning.\n"
            "[/VERBATIM-FELLESKATALOGEN]\n\n"
            "VIKTIG: Kilde- og URL-linjene SKAL stå ØVERST i blokken — aldri "
            "nederst — slik at de er bevart selv om Dosering-seksjonen er lang.\n\n"
    ...
    "hapi-ndla-agent": {
        "instructions": (
            ...
            "OG format=\"tekst\" (alltid — \"tekst\" eller \"html\" er eneste gyldige verdier).\n"
            ...
            "Steg 2: Hvis utdraget er kort og bruker trenger detaljer → 'hent_ndla_artikkel' med format=\"tekst\"\n"
